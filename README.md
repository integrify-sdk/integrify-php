...
| [`kapitalbank`](packages/kapitalbank)       | `integrify/kapitalbank`    |                                                        ✅                                                        | [`integrify-kapitalbank`](https://github.com/integrify-sdk/integrify-python/tree/main/packages/kapitalbank)       |
| [`postaguvercini`](packages/postaguvercini) | `integrify/postaguvercini` |                                                        ✅                                                        | [`integrify-postaguvercini`](https://github.com/integrify-sdk/integrify-python/tree/main/packages/postaguvercini) |
| [`azericard`](packages/azericard)           | `integrify/azericard`      |                                                        ✅                                                        | [`integrify-azericard`](https://github.com/integrify-sdk/integrify-python/tree/main/packages/azericard)           |
